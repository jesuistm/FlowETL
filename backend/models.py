...
class Feedback(BaseModel):
    ...
    errors : List[str] = Field("Validation feedback detailing critical errors")
    plan : Plan = Field("Plan on which the feedback was computed on")
...
class GraphState(TypedDict, total=False):
    ...
    validation: Dict[str, Any] = Field("Latest feedback from validator, including both the plan validated and any errors detected")
